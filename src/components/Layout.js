			...
			<React.Fragment>
				...
				<section className="latest-movie-wrapper">
					<div className="container">
									...
									<div className="col-lg-3 col-md-6 col-sm-6 col-12" key={i}>
										<div className="latest-item">
											...
											<div className="sort-info">
												{movie.genres.slice(0, 3).map((gen, i) => (
													<div className="genres" key={i}>
														<span className={gen}>{gen}</span>
													</div>
												))}
												<h2>
													{movie.title_english} <span>{movie.year}</span>
												</h2>
												<h4>
											...
											<Link to={`/movie/${movie.slug}?id=${movie.id}`}>
												View details
											</Link>
										</div>
									</div>
						...
						<div className="row ">
							<div className="col-md-12 text-center">{searchPageStatus}</div>
						</div>
					</div>
				</section>
							...
							<div className="col-lg-9 col-md-8">
								<div className="tranding-movies">
									<div className="row">
										...
										<div className="col-md-6 col-sm-6 col-5">
											<Link to="/popular">
												<h2 className="view-more text-right">View All </h2>
											</Link>
										</div>
									</div>
									<div className="row">
									...
									<ul>
										{upComingMovie.slice(0, 5).map((movie, i) => (
											<li key={i}>
												...
												<h4>
													{movie.title}
													<span>Relese {movie.release_date}</span>
												</h4>
											</li>
										))}
									</ul>
